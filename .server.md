...
```
0:000> .server tcp:port=1234,password=password
Server started.  Client can connect with any of these command lines
0: <debugger> -remote tcp:Port=1234,Password=*,Server=EXPLOIT-7
```

- **Client**

```
File >> Connect to Remote Session... (Ctrl+R)
```

Use the following connection string.

```
tcp:Port=1234,Password=*,Server=EXPLOIT-7 or <IP Address>
```